...
*/
class RdsSwitch extends homebridgeLib.ServiceDelegate {
...
/*  static get SmokeSensor () { return RpiSmokeSensor }
  ...
  static get RdsMotion () { return RdsMotion }
...
*/
  constructor (rdsAccessory, params = {}) {
    ...
    this.random = rdsAccessory.random
    this.repeat = rdsAccessory.repeat
    this.addCharacteristicDelegate({
      key: 'on',
      Characteristic: this.Characteristics.hap.On,
      setter: async (value) => {
        rdsAccessory.switchOn = value
//      await this.update()
      },
      getter: async () => {
        return rdsAccessory.switchOn
      }
    })
...
module.exports = RdsSwitch
// module.exports = RdsMotion
