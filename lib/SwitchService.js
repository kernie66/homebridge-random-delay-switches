...
//    this.startOnReboot = switchAccessory.startOnReboot
    ...
    this.addCharacteristicDelegate({
      key: 'on',
      value: switchAccessory.startOnReboot,
...
//        switchAccessory.emit('trigger', value)
        ...
        this.setOn(switchAccessory, ac)
//        this.log('Triggering motion sensor');

//      await this.update()
//      },
//      getter: async () => {
//        return switchAccessory.switchOn
      }
    })
...
//        await this.update
  ...
  async setOn (switchAccessory, ac) {
//    signal.addEventListener("abort", () => {
//      this.log("Got abort signal!")
//    })
...
//      clearTimeout(this.timer);
      ...
      try {
        await sleep(this.timeout, null, { signal = ac.signal })
        this.log('Time is up!')
