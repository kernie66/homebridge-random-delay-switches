...
//      maxValue: 3600,
    ...
    this.createCharacteristicClass('DelayHour', uuid('0AA'), {
      format: this.Formats.UINT16,
//      unit: this.Units.SECONDS,
      minValue: 0,
      maxValue: 23,
    ...
    this.createCharacteristicClass('DelayMinute', uuid('0AB'), {
      format: this.Formats.UINT16,
//      unit: this.Units.SECONDS,
      minValue: 0,
      maxValue: 59,
    ...
    this.createCharacteristicClass('DelaySecond', uuid('0AC'), {
      format: this.Formats.UINT16,
      unit: this.Units.SECONDS,
      minValue: 0,
      maxValue: 59,
