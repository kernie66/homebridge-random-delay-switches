...
const MotionAccessory = require('./MotionAccessory')
...
//        delaySwitch: delaySwitch,
      ...
      const switchAccessory = new SwitchAccessory(this, params)
      ...
      if (!delaySwitch.disableSensor) {
        const motionAccessory = new MotionAccessory(this, params)
