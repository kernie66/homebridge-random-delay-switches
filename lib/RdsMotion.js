// homebridge-random-delay-switches/lib/RdsMotion.js
...
class RdsMotion extends homebridgeLib.ServiceDelegate {
  constructor (rdsAccessory, params = {}) {
    params.name = rdsAccessory.name + ' Trigger'
    params.Service = rdsAccessory.Services.hap.MotionSensor
    super(rdsAccessory, params)
    this.addCharacteristicDelegate({
      key: 'motion',
      Characteristic: this.Characteristics.hap.MotionDetected
      getter: async () => {
        return rdsAccessory.motionTriggered
      }
    })
    this.addCharacteristicDelegate({
      key: 'lastActivation',
