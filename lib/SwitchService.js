...
class SwitchService extends homebridgeLib.ServiceDelegate {
  constructor (switchAccessory, params = {}) {
    ...
    this.log('rds in Service: %s', this.rds.Characteristics)
...
//      }
    ...
    .on('didSet', (value) => {
      switchAccessory.random <= value
      if (value) {
        this.log('Random delay enabled')
      } else {
        this.log('Random delay disabled')
      }
      this.log('Ch: %s', this.Characteristics)
      this.log('Ch.my: %s', this.Characteristics.my)
      this.log('Ch.my.En: %s', this.Characteristics.my.Enabled)
      this.log('rds.Ch: %s', this.rds.Characteristics)
      this.log('rds.Ch.Rnd: %s', this.rds.Characteristics.Random)
    })
...
//      }
  ...
  updateValues (switchAccessory) {
    ...
    this.values.enabled = switchAccessory.random    
  }
}
